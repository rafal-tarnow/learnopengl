...
private:
    ...
    // ------------------------------------------------------------------------
    void checkCompileErrors(char * fileName, GLuint shader, std::string type)
    {
        GLint success;
        GLchar infoLog[1024];
        ...
        if(type != "PROGRAM")
        {
            ...
            if(!success)
            {
                ...
                std::cout << "ERROR:: " << file << " SHADER_COMPILATION_ERROR of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
        else
        {
            ...
            if(!success)
            {
                ...
                std::cout << "ERROR:: " << file << " PROGRAM_LINKING_ERROR of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
    }
};
